...
all_dict(L, os.path.expanduser("~/blog/daehl-e/static/python/skijump/excel365/L_all_ids.json"))
all_dict(M, os.path.expanduser("~/blog/daehl-e/static/python/skijump/excel365/M_all_ids.json"))
