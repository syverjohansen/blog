...
# Load your data
print("Loading data...")
L_chrono = pl.read_csv(os.path.expanduser('~/ski/elo/python/skijump/polars/excel365/ladies_chrono.csv'))
M_chrono = pl.read_csv(os.path.expanduser('~/ski/elo/python/skijump/polars/excel365/men_chrono.csv'))
...
def calculate_elo_percentages(df):
    ...
    """
    # Elo columns to process for ski jumping
    elo_columns = [
...
def process_balanced_data():
    ...
    output_base = os.path.expanduser('~/blog/daehl-e/static/python/skijump/excel365')
    ...
    print("All ski jump files have been processed and grouped successfully.")

# Complete country code mapping for ski jumping
