...
men_df = pd.read_csv(os.path.expanduser('~/ski/elo/python/biathlon/polars/excel365/men_chrono.csv'))
ladies_df = pd.read_csv(os.path.expanduser('~/ski/elo/python/biathlon/polars/excel365/ladies_chrono.csv'))
...
output_dir = os.path.expanduser('~/blog/daehl-e/static/python/biathlon/excel365')
