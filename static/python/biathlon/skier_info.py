...
L_chrono = pl.read_ipc(os.path.expanduser('~/ski/elo/python/biathlon/polars/excel365/ladies_chrono.feather'))


M_chrono = pl.read_ipc(os.path.expanduser('~/ski/elo/python/biathlon/polars/excel365/men_chrono.feather'))
