...
L_chrono = pl.read_ipc('/Users/syverjohansen/ski/elo/python/biathlon/polars/excel365/ladies_chrono.feather')


M_chrono = pl.read_ipc('/Users/syverjohansen/ski/elo/python/biathlon/polars/excel365/men_chrono.feather')
...
for a in range(2):
	...
	print(df)
	file_path = f"/Users/syverjohansen/blog/daehl-e/static/python/biathlon/excel365/{sex}/skier_info.json"
