...
current_dict(L, os.path.expanduser("~/blog/daehl-e/static/python/excel365/L_current_ids.json"))
current_dict(M, os.path.expanduser("~/blog/daehl-e/static/python/excel365/M_current_ids.json"))
