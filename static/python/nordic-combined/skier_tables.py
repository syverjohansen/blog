...
# Load your data
print("Loading data...")
L_chrono = pl.read_ipc('/Users/syverjohansen/ski/elo/python/nordic-combined/polars/excel365/ladies_chrono.feather')
M_chrono = pl.read_ipc('/Users/syverjohansen/ski/elo/python/nordic-combined/polars/excel365/men_chrono.feather')
...
def calculate_elo_percentages(df):
    ...
    """
    # Elo columns to process for nordic combined
    elo_columns = [
        "Elo", "Individual_Elo", "IndividualCompact_Elo", "MassStart_Elo", "Sprint_Elo"
    ]
...
def process_balanced_data():
    ...
    output_base = '/Users/syverjohansen/blog/daehl-e/static/python/nordic-combined/excel365'
    ...
    print("All nordic combined files have been processed and grouped successfully.")

# Complete country code mapping for nordic combined
