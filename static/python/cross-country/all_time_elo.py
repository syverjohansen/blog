...
def process_all_time_records(df, file_path):
    ...
    column_mapping = {
        'Elo': 'Overall',
        'Distance_Elo': 'Distance',
        'Distance_C_Elo': 'Distance C',
        'Distance_F_Elo': 'Distance F',
        'Sprint_Elo': 'Sprint',
        'Sprint_C_Elo': 'Sprint C',
        'Sprint_F_Elo': 'Sprint F',
        'Classic_Elo': 'Classic',
        'Freestyle_Elo': 'Freestyle'
    }
    ...
    all_time_records = all_time_records[[
        "Place", "Skier", "Nation", "Overall", "Distance", 
        "Distance C", "Distance F", "Sprint", 
        "Sprint C", "Sprint F", "Classic", 
        "Freestyle", "ID"
    ]]
...
for i, df in enumerate(chronos):
    ...
    file_path = os.path.expanduser(f"~/blog/daehl-e/static/python/cross-country/excel365/{chronos_str[i]}_all_time.json")
