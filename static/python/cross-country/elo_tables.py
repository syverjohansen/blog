...
L = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L.csv'))
L_Distance = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Distance.csv'))
L_Distance_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Distance_C.csv'))
L_Distance_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Distance_F.csv'))
L_Sprint = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Sprint.csv'))
L_Sprint_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Sprint_C.csv'))
L_Sprint_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_Sprint_F.csv'))
L_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_C.csv'))
L_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/L_F.csv'))
L_chrono = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/ladies_chrono.csv'))

M = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M.csv'))
M_Distance = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Distance.csv'))
M_Distance_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Distance_C.csv'))
M_Distance_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Distance_F.csv'))
M_Sprint = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Sprint.csv'))
M_Sprint_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Sprint_C.csv'))
M_Sprint_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_Sprint_F.csv'))
M_C = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_C.csv'))
M_F = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/M_F.csv'))
M_chrono = pd.read_csv(os.path.expanduser('~/ski/elo/python/ski/polars/excel365/men_chrono.csv'))
