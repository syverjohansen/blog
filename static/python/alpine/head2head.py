...
men_df = pd.read_csv(os.path.expanduser('~/ski/elo/python/alpine/polars/excel365/men_chrono.csv'))
ladies_df = pd.read_csv(os.path.expanduser('~/ski/elo/python/alpine/polars/excel365/ladies_chrono.csv'))
