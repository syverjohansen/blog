...
# Load your data
print("Loading data...")
L_chrono = pl.read_csv(os.path.expanduser('~/ski/elo/python/alpine/polars/excel365/ladies_chrono.csv'))
M_chrono = pl.read_csv(os.path.expanduser('~/ski/elo/python/alpine/polars/excel365/men_chrono.csv'))
...
def calculate_elo_percentages(df):
    ...
    """
    # Elo columns to process for alpine skiing
    elo_columns = [
        "Elo", "Downhill_Elo", "Super G_Elo", "Giant Slalom_Elo", "Slalom_Elo", 
        "Combined_Elo", "Tech_Elo", "Speed_Elo"
    ]
...
def process_balanced_data():
    ...
    output_base = os.path.expanduser('~/blog/daehl-e/static/python/alpine/excel365')
    ...
    print("All alpine skiing files have been processed and grouped successfully.")

# Complete country code mapping for alpine skiing
