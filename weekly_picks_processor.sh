...
LOG_FILE="$HOME/blog/daehl-e/logs/weekly-picks-processor-$(date +%Y-%m-%d).log"
...
DRAFTS_DIR="$HOME/blog/daehl-e/content/post/cross-country/drafts/weekly-picks"
OUTPUT_DIR="$HOME/blog/daehl-e/content/post/weekly-picks"
JSON_OUTPUT_DIR="$HOME/blog/daehl-e/data/cross-country/weekly-picks"
EXCEL_SCRIPT="$HOME/blog/daehl-e/static/python/excel_to_hugo_multiple_sheets.py"

log "===== STARTING WEEKLY PICKS PROCESSING ====="
...
---
layout:     post
title:      "Weekly Picks for $FORMATTED_DATE"
date:       $FORMATTED_DATE
...
{{< cross-country/datatable "cross-country/weekly-picks/$TODAY_DATE/$BASE_NAME" >}}
...
log "===== WEEKLY PICKS PROCESSING COMPLETED ====="